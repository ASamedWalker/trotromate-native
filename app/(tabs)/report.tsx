...
const styles = (isDark: boolean) => {
  ...
  return StyleSheet.create({
    ...
    headerTitle: { fontSize: 28, fontFamily: font.extrabold, marginBottom: 8, color: t.text, letterSpacing: -0.5 },
    headerSub: { fontSize: 15, color: t.textSecondary },
    ...
    cardTitle: { fontSize: 17, fontFamily: font.bold, color: t.text },
    ...
    statValue: { fontSize: 26, fontFamily: font.extrabold, color: t.text, letterSpacing: -0.5 },
    statLabel: { fontSize: 11, fontFamily: font.medium, color: t.textSecondary, marginTop: 4, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  })
}
